...
- 이 글은 AI 에 대한 내 생각과 현재까지 내가 이용해왔던 모델과 서비스들을 돌아보고, 현재 어떤 모델과 서비스를 사용하며 개발 시 어떻게 AI 를 활용하고 있는지 정리하기 위해 작성했다.
...
- 굳이 괜한 아집으로 구독하지 않은 서비스는 Claude 인데, 하도 많은 사람들이 호들갑을 떨어서 오히려 손이 가지 않았다.
